  ...
  <div style="width: 100%; height: 600px">
    ...
    <div class="tableDiv">
      <el-table :data="tableData" border height="100%" style="width: 100%">
        ...
        <el-table-column prop="orderId" label="任务编号" width="180">
        </el-table-column>
        <el-table-column prop="createTime" label="订单日期" width="160">
        </el-table-column>
        <el-table-column prop="orderNo" label="订单编号"> </el-table-column>
        <el-table-column prop="batchId" label="灭菌批号"> </el-table-column>
        <el-table-column prop="orderName" label="订单名称"> </el-table-column>
        <el-table-column prop="productName" label="产品名称"> </el-table-column>
        <el-table-column prop="artName" label="工艺名称"> </el-table-column>
        <el-table-column label="操作" width="130">
          <template slot-scope="scope">
            <el-link type="primary" @click="updateBoxReportData(scope.row)"
              >修改</el-link
            >
            <el-link
              type="primary"
              @click="showBoxReportData(scope.row)"
              style="margin-left: 10px"
              >原始记录</el-link
            >
          </template>
    ...
    >
      <div style="width: 100%">
        <el-descriptions class="margin-top" :column="3" border>
          ...
          <el-descriptions-item>
            <template slot="label"> 灭菌批号 </template>
          ...
          <el-descriptions-item>
            <template slot="label"> 工艺名称 </template>
            {{ this.updateOrderInfo.artName }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template slot="label"> 圈数 </template>
            {{ this.updateOrderInfo.numberTurns }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template slot="label"> 操作员 </template>
            {{ this.updateOrderInfo.creatorName }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template slot="label"> 辐照数量 </template>
            {{ this.boxList.length }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template slot="label"> 箱信息 </template>
            <div
              style="width: 1260px; height: 400px; overflow-y: auto"
            ...
            >
              ...
              >
                ...
                ><span style="font-size: 17px; margin-left: 2px">添加箱子</span>
              </div>
              <div
              ...
              >
                <el-button
                  ...
                  circle
                  size="mini"
                  style="position: absolute; right: 0px; top: 0px; padding: 3px"
                  @click="deleteBox(item.orderId, item.boxImitateId)"
                ...
                <div class="box-row">
                  ...
                  <div class="box-row-right">
                    <el-button
                      type="text"
                      icon="el-icon-edit"
                      @click="showUpdateBoxImitateId(item)"
                      :disabled="showHistory"
                    ></el-button
                    >{{ item.boxImitateId }}
                  </div>
