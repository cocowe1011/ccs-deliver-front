  ...
  <div style="width: 100%; height: 100%">
    <div class="dict-order-top">
      <el-button
        ...
        >新建配方</el-button
      >
      <el-button type="info" icon="el-icon-refresh" @click="getDictOrder()"
        >刷新</el-button
      >
    </div>
    <div class="dict-order-down">
      <div
        v-if="dictOrderList.length > 0"
        style="
          width: 100%;
          height: 100%;
      ...
      >
        ...
        >
          <div
            :class="[
              'dict-list-card',
              activeIndex == index ? 'dict-list-card-active' : ''
            ]"
        ...
        >
          ...
          >
            <el-form-item label="订单名称：">
              <el-input
                size="small"
                v-model="dictOrderForm.orderName"
                placeholder="订单名称"
              ></el-input>
            </el-form-item>
            <el-form-item>
            ...
            <el-form-item>
              <el-checkbox v-model="dictOrderForm.trayFlag"
                >托盘模式</el-checkbox
              >
            </el-form-item>
            <br />
            <el-form-item label="产品名称：">
              <el-input
                size="small"
                v-model="dictOrderForm.productName"
                placeholder="产品名称"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="装载方式：">
              <el-input
                size="small"
                v-model="dictOrderForm.loadMethod"
                placeholder="装载方式"
              ></el-input>
            </el-form-item>
            <el-form-item label="路径名称：">
              <el-input
                size="small"
                v-model="dictOrderForm.pathName"
                placeholder="路径名称"
              ></el-input>
            </el-form-item>
            <el-form-item label="圈数：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.numberTurns"
                placeholder="圈数"
              ></el-input>
            </el-form-item>
            <el-form-item label="箱子长度：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.boxLength"
                placeholder="箱子长度"
              ></el-input>
            </el-form-item>
            <el-form-item label="箱子高度：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.boxHeight"
                placeholder="箱子高度"
              ></el-input>
            </el-form-item>
            <el-form-item label="箱子宽度：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.boxWidth"
                placeholder="箱子宽度"
              ></el-input>
            </el-form-item>
            <el-form-item label="箱子重量：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.boxWeight"
                placeholder="箱子重量"
              ></el-input>
            </el-form-item>
            <el-form-item label="束下速度下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.sxSpeedLowerLimit"
                placeholder="束下速度下限"
              ></el-input>
            </el-form-item>
            <el-form-item label="束下速度值：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.sxSpeedSet"
                placeholder="束下速度值"
              ></el-input>
            </el-form-item>
            <el-form-item label="束下速度上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.sxSpeedUpperLimit"
                placeholder="束下速度上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="束流下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.slLowerLimit"
                placeholder="束流下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="束流上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.slUpperLimit"
                placeholder="束流上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="功率下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.glLowerLimit"
                placeholder="功率下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="功率上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.glUpperLimit"
                placeholder="功率上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="扫宽下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.skLowerLimit"
                placeholder="扫宽下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="扫宽上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.skUpperLimit"
                placeholder="扫宽上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="扫描频率下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.smplLowerLimit"
                placeholder="扫描频率下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="扫描频率上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.smplUpperLimit"
                placeholder="扫描频率上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="PFN电压下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.pfnLowerLimit"
                placeholder="PFN电压下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="PFN电压上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.pfnUpperLimit"
                placeholder="PFN电压上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="能量下限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.nlLowerLimit"
                placeholder="能量下限"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="能量上限：">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.nlUpperLimit"
                placeholder="能量上限"
              ></el-input>
            </el-form-item>
            <el-form-item label="订单箱数：" v-show="false">
              <el-input
                type="number"
                size="small"
                v-model="dictOrderForm.orderBoxNum"
                placeholder="订单箱数"
              ></el-input>
            </el-form-item>
          </el-form>
    ...
    >
      <el-input
        v-model="dictOrderForm.dictName"
        placeholder="请输入配方名称"
      ></el-input>
      <span slot="footer" class="dialog-footer">
    ...
    update() {
      ...
      HttpUtil.post('/dict/update', this.dictOrderForm)
        .then((res) => {
          ...
          this.dictOrderForm.revertFlag =
            this.dictOrderForm.revertFlag == '1' ? true : false;
          this.dictOrderForm.trayFlag =
            this.dictOrderForm.trayFlag == '1' ? true : false;
          setTimeout(() => {
            this.dictOrderLoading = false;
          }, 500);
        })
