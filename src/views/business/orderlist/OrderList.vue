<template>
  <div style="width: 100%; height: 100%">
          ...
          <div class="card-content">
            ...
            >
              <el-form-item label="订单编号：">
                <el-input
                  size="small"
                  v-model="orderMainForm.orderNo"
                  placeholder="订单编号"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="订单名称：">
                <el-input
                  size="small"
                  v-model="orderMainForm.orderName"
                  placeholder="订单名称"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item>
                <el-checkbox
                  v-model="orderMainForm.revertFlag"
                  :disabled="
                    !(isNewSave || isEdit) ||
                    ((isNewSave || isEdit) && orderMainForm.trayFlag)
                  "
                  >翻转</el-checkbox
                >
              </el-form-item>
              <el-form-item>
                <el-checkbox
                  v-model="orderMainForm.trayFlag"
                  :disabled="
                    !(isNewSave || isEdit) ||
                    ((isNewSave || isEdit) && orderMainForm.revertFlag)
                  "
                  >托盘模式</el-checkbox
                >
              </el-form-item>
              ...
              <el-form-item label="产品名称：">
                <el-input
                  size="small"
                  v-model="orderMainForm.productName"
                  placeholder="产品名称"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="装载方式：">
                <el-input
                  size="small"
                  v-model="orderMainForm.loadMethod"
                  placeholder="装载方式"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="路径名称：">
                <el-input
                  size="small"
                  v-model="orderMainForm.pathName"
                  placeholder="路径名称"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="圈数：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.numberTurns"
                  placeholder="圈数"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="箱子长度：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.boxLength"
                  placeholder="箱子长度"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="箱子高度：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.boxHeight"
                  placeholder="箱子高度"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="箱子宽度：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.boxWidth"
                  placeholder="箱子宽度"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="箱子重量：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.boxWeight"
                  placeholder="箱子重量"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="订单箱数：" v-show="false">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.orderBoxNum"
                  placeholder="订单箱数"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="束下速度下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.sxSpeedLowerLimit"
                  placeholder="束下速度下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="束下速度值：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.sxSpeedSet"
                  placeholder="束下速度值"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="束下速度上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.sxSpeedUpperLimit"
                  placeholder="束下速度上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="束流下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.slLowerLimit"
                  placeholder="束流下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="束流上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.slUpperLimit"
                  placeholder="束流上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="功率下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.glLowerLimit"
                  placeholder="功率下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="功率上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.glUpperLimit"
                  placeholder="功率上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="扫宽下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.skLowerLimit"
                  placeholder="扫宽下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="扫宽上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.skUpperLimit"
                  placeholder="扫宽上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="扫描频率下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.smplLowerLimit"
                  placeholder="扫描频率下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="扫描频率上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.smplUpperLimit"
                  placeholder="扫描频率上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="PFN电压下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.pfnLowerLimit"
                  placeholder="PFN电压下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="PFN电压上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.pfnUpperLimit"
                  placeholder="PFN电压上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="能量下限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.nlLowerLimit"
                  placeholder="能量下限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="能量上限：">
                <el-input
                  type="number"
                  size="small"
                  v-model="orderMainForm.nlUpperLimit"
                  placeholder="能量上限"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
              <el-form-item label="操作员：">
                <el-input
                  size="small"
                  v-model="orderMainForm.creatorName"
                  placeholder="操作员"
                  :readonly="!(isNewSave || isEdit)"
                ></el-input>
              </el-form-item>
            ...
            <div class="content-bottom" v-show="isNewSave || isEdit">
              ...
              <el-select
                ...
                v-if="isNewSave"
                filterable
                placeholder="可输入汉字检索配方"
                @visible-change="getDictOrder"
                @change="selectDictOrder"
                size="small"
              >
                <el-option
        ...
        <div class="listDiv">
          <div class="list-top">
            ...
            <el-button
              ...
              size="small"
              @click="getOrderList"
              style="margin-left: 15px; margin-right: 6px"
              >刷新</el-button
            >
            <el-divider
              direction="vertical"
            ...
            >
              <el-button
                ...
                style="margin-left: 6px"
                @click="positionOrder"
                >当前正在运行的订单：{{ nowRunOrderId }}</el-button
              >
            </el-tooltip>
          </div>
              ...
              <el-table-column fixed="right" label="操作" width="320">
                <template slot-scope="scope">
                  ...
                  <el-link
                    ...
                    v-if="scope.row.orderId != nowRunOrderId"
                    :disabled="
                      scope.row.orderId !== currentSelect.orderId ||
                      (nowRunOrderId != '' &&
                        scope.row.orderId != nowRunOrderId)
                    "
                    @click="chooseOrder(scope.row, false)"
                    >开始</el-link
                  >
                  <el-link
                    type="success"
                  ...
                  <el-link
                    ...
                    style="margin-left: 10px"
                    @click="showDynamicGraph(scope.row)"
                    :disabled="
                      scope.row.orderId !== currentSelect.orderId ||
                      (nowRunOrderId != '' &&
                        scope.row.orderId != nowRunOrderId) ||
    ...
    <div style="width: 100%; height: 100%" v-show="isDynamicGraphShow">
      <DynamicGraph
        @closeDynamicGraphShow="closeDynamicGraphShow"
        @returnGenerateBatchReport="returnGenerateBatchReport"
    ...
    <div
      :class="zhankaiflag ? 'zhankai-div' : ''"
      @click.self="zhankaiflag = false"
    >
      <div :class="['patlist', zhankaiflag ? 'open' : '']">
        <div class="huakuai" style="z-index: 1000" @click="zhankai()">
          ...
          <span style="font-size: 15px"> 工艺配方 </span>
        </div>
        <div class="patlist-container">
          <div class="patlist-container-wrapper">
            <span class="patlist-container-wrapper-title"
              >维护工艺配方模板</span
            >
            <span
              class="patlist-container-wrapper-close"
              @click="zhankaiflag = false"
...
export default {
  ...
  methods: {
    ...
    editClick(val) {
      ...
      this.orderMainForm.revertFlag =
        this.orderMainForm.revertFlag == '翻转' ? true : false;
      this.orderMainForm.trayFlag =
        this.orderMainForm.trayFlag == '1' ? true : false;
      this.currentSelect = val;
      // alert(JSON.stringify(orderMain))
    },
    async saveOrder() {
      if (
        this.orderMainForm.orderNo == '' ||
        this.orderMainForm.orderNo == undefined
      ) {
        this.$message.error('订单编号必须填写！');
        return false;
      }
      if (
        this.orderMainForm.batchId == '' ||
        this.orderMainForm.batchId == undefined
      ) {
      ...
      await HttpUtil.post('/order/save', this.orderMainForm)
        .then((res) => {
          if (res.data === 1) {
            ...
            this.orderMainForm.revertFlag =
              this.orderMainForm.revertFlag == '1' ? true : false;
            this.orderMainForm.trayFlag =
              this.orderMainForm.trayFlag == '1' ? true : false;
    ...
    async updateOrder() {
      ...
      this.orderMainForm.revertFlag = this.orderMainForm.revertFlag ? '1' : '0';
      this.orderMainForm.trayFlag = this.orderMainForm.trayFlag ? '1' : '0';
      await HttpUtil.post('/order/update', this.orderMainForm)
        .then((res) => {
          if (res.data === 1) {
    ...
    async chooseOrder(obj, changeFlag) {
      ...
      // 更新订单开始时间
      HttpUtil.post('/order/update', param)
        .then((res) => {
          if (res.data == 1) {
    ...
    positionOrder() {
      ...
      const index = this.tableData.findIndex(
        (element) => element.orderId == this.nowRunOrderId
      );
      this.$nextTick(() => {
