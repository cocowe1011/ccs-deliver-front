<template>
  <div class="dynamic">
    <el-button
      type="danger"
      icon="el-icon-close"
      style="position: absolute; z-index: 999; right: 35px; top: 70px"
      @click="closeDynamicGraphShow"
    ></el-button>
    <el-button
      type="primary"
      plain
      style="position: absolute; z-index: 999; right: 130px; top: 75px"
      @click="testAcc"
      >测试加速器</el-button
    >
          ...
          <div class="card-content">
            ...
            <div class="data-card" style="padding: 7px 10px 14px 10px">
              <div class="data-card-border">
                ...
                <div class="data-card-border-borderDown">
                  {{
                    orderMainDy.trayFlag === '1'
                      ? '托盘模式'
                      : orderMainDy.revertFlag === '翻转'
                      ? '翻转模式'
                      : '回流模式'
                  }}
                </div>
      ...
      <div class="dynamic-left-middle">
        <div>
          ...
          <div class="card-content" style="display: flex; align-items: center">
            <!-- 操作按钮 -->
            <div
              :class="['img', fullPause ? 'img-active' : '']"
              @click="operationConfirm('suspend')"
            >
              全线<br />暂停
            </div>
            <div
              :class="['img', fullRun ? 'img-active' : '']"
              @click="operationConfirm('run')"
            >
              全线<br />启动
            </div>
            <div
              :class="['img', fullStop ? 'img-active' : '']"
              @click="operationConfirm('stop')"
            >
              全线<br />停止
            </div>
      ...
      <div class="dynamic-left-down">
        <div>
          <div class="card-title">
            <el-badge
              :value="logNotReadNumber"
              :max="99"
              class="item"
              :hidden="logNotReadNumber == 0"
            >
              <div
                :class="[
                  'log-class',
                  logPageFlag == 'log' ? 'log-class-active' : ''
                ]"
                @click="showRunlog"
              >
                操作日志
            ...
            &nbsp;/&nbsp;
            <el-badge
              :value="errorLogNotReadNumber"
              :max="99"
              class="item"
              :hidden="errorLogNotReadNumber == 0"
            >
              <div
                :class="[
                  'log-class',
                  logPageFlag == 'error-log' ? 'log-class-active' : ''
                ]"
                @click="showErrorlog"
              >
                报警日志
          ...
          <div class="card-content" ref="logContainer">
            ...
            <template v-else>
              <div
                class="log-text"
                v-for="(message, index) in errorLogArr"
                :key="index"
              >
                {{ message.text }}
              </div>
    ...
    <div class="dynamic-right">
      <div>
        ...
        >
          <div
            class="dyscare chuansongpadding"
          ...
          >
            ...
            />
            <div
              class="show-data-area"
              style="position: absolute; right: 80px; top: 490px"
            >
              ...
              <div class="show-data-area-content">
                <el-input
                  readonly
                  size="small"
                  v-model="nowABoxImitateId"
                ></el-input>
              </div>
            </div>
            <div
              class="show-data-area"
              style="position: absolute; right: 80px; top: 528px"
            >
              <div class="show-data-area-top">上货扫码信息</div>
              <div class="show-data-area-content">
                <el-input
                  v-model="loadScanCode"
                  readonly
                  size="small"
                ></el-input>
              </div>
            ...
            <div
              class="show-data-area"
              style="position: absolute; right: 80px; top: 569px"
            >
            ...
            <div
              class="show-data-area"
              style="position: absolute; left: 178px; top: 475px"
            >
              <div class="show-data-area-top">ID信息</div>
              <div class="show-data-area-content">
                <el-input
                  readonly
                  size="small"
                  v-model="nowEBoxImitateId"
                ></el-input>
              </div>
            </div>
            <div
              class="show-data-area"
              style="position: absolute; left: 178px; top: 513px"
            >
              <div class="show-data-area-top">下货扫码信息</div>
              <div class="show-data-area-content">
                <el-input
                  v-model="labyrinthScanCode"
                  readonly
                  size="small"
                ></el-input>
              </div>
            ...
            <div
              class="show-data-area"
              style="position: absolute; left: 194px; top: 560px"
            >
            ...
            <div
              ...
              "
            >
              <div class="show-data-area-top" style="width: 100%; height: 26px">
                束下当前货物ID
              </div>
              <div
                class="show-data-area-content"
            ...
            <div
              class="guangdian"
              style="top: 447px; right: 86px"
              @click="analogOptoelectronics('A')"
            >
            ...
            <div
              class="guangdian"
              style="top: 185px; right: 140px"
              @click="analogOptoelectronics('B')"
            >
            ...
            <div
              class="guangdian"
              style="top: 185px; right: 612px"
              @click="analogOptoelectronics('C')"
            >
            ...
            <div
              class="guangdian"
              style="top: 331px; right: 654px"
              @click="analogOptoelectronics('D')"
            >
            ...
            <div
              class="guangdian"
              style="top: 434px; right: 674px"
              @click="analogOptoelectronics('E')"
            >
            ...
            <div
              class="guangdian"
              style="right: 827px; top: 551px"
              @click="analogOptoelectronics('F')"
            >
            ...
            <div
              class="guangdian"
              style="right: 792px; top: 600px"
              @click="analogOptoelectronics('G')"
            >
            ...
            <div
              class="guangdian"
              style="right: 446px; top: 683px"
              @click="analogOptoelectronics('H')"
            >
            ...
            <div
              :class="[
                'dianji',
                dianJiStatusArr[7] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 640px; right: 133px"
            >
              100#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[6] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 416px; right: 6px"
            >
              101#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[5] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 386px; right: 190px"
            >
              102#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[4] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 258px; right: 190px"
            >
              103#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[3] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 132px; right: 190px"
            >
              104#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[2] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 88px; right: 450px"
            >
              105#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[1] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 131px; right: 538px"
            >
              106#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[0] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 259px; right: 516px"
            >
              107#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[15] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 379px; right: 516px"
            >
              108#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[14] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 379px; right: 641px"
            >
              109#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[13] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 420px; right: 727px"
            >
              110#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[12] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 638px; right: 730px"
            >
              111#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[11] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 639px; right: 627px"
            >
              112#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[10] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 596px; right: 450px"
            >
              113#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[9] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 596px; right: 264px"
            >
              114#电机
            </div>
            <div
              :class="[
                'dianji',
                dianJiStatusArr[8] == '1' ? 'dianji-active' : ''
              ]"
              style="top: 690px; right: 367px"
            >
              115#电机
            </div>
            <!-- 队列信息 -->
            <el-link
              ...
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('AB')"
              >{{ '101-103区域货物缓存队列 (' + arrAB.length + ')' }}</el-link
            >
            <el-link
              type="danger"
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('BC')"
              >{{ '104-106区域货物缓存队列 (' + arrBC.length + ')' }}</el-link
            >
            <el-link
              type="danger"
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('CD')"
              >{{ '107-109区域货物缓存队列 (' + arrCD.length + ')' }}</el-link
            >
            <el-link
              type="danger"
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('DG')"
              >{{
                '110-111区域货物缓存队列 (' +
                (arrDG.length + tempArrF.length) +
                ')'
              }}</el-link
            >
            <el-link
              ...
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('F')"
              >{{ '剔除货物缓存队列 (' + arrF.length + ')' }}</el-link
            >
            <el-link
              type="danger"
              style="
                ...
                font-weight: 600;
              "
              @click="showChuanSong('GH')"
              >{{
                '下货区缓存队列 (' + (arrGH.length + thoughHArr.length) + ')'
              }}</el-link
            >
            <!-- 预警 -->
            <img
              ...
              class="warning-img"
              v-show="yujingShow"
              style="left: 41px; top: 663px"
            />
            <img
              src="./img/baojing.png"
              class="warning-img"
              v-show="baojingShow"
              style="top: 717px; left: 352px"
            />
            <div
              style="
                width: 70px;
            ...
            <el-button
              ...
              v-show="baojingShow"
              @click="downClick"
              style="position: absolute; right: 271px; top: 744px"
              plain
              >下货完成</el-button
            >
          </div>
    ...
    >
              ...
              <tbody>
                ...
                >
                  ...
                  <td style="width: 130px">
                    {{ item.turnsInfoList[0].passATime }}
                  </td>
                  <td style="width: 60px">{{ item.numberTurns }}</td>
                  <td style="width: 60px">
                    {{ item.revertFlag == '翻转' ? '√' : 'X' }}
                  </td>
                  ...
                  <td style="width: 60px">
                    <el-tag type="success" v-if="item.xiahuoFlag" size="mini"
                      >已下货</el-tag
                    >
                    <el-tag
                      type="warning"
                      v-if="item.tichuFlag === 'WAIT_PUT_OUT'"
                      size="mini"
                      >待剔除</el-tag
                    >
                    <el-tag
                      type="danger"
                      v-if="item.tichuFlag === 'HAVE_PUT_OUT'"
                      size="mini"
                      >已剔除</el-tag
                    >
                    <el-tag
                      v-if="
                        !item.xiahuoFlag &&
                        item.tichuFlag !== 'WAIT_PUT_OUT' &&
                        item.tichuFlag !== 'HAVE_PUT_OUT'
                      "
                      size="mini"
                      >执行中</el-tag
                    >
                  ...
                  <td style="width: 50px">
                    <el-popconfirm
                      :title="
                        '确定要将' + item.boxImitateId + '在队列中删除吗？'
                      "
      ...
      <div class="drawer-right">
        <div
          :class="['transform-card', traAB ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('AB', $event)"
          @click="showCache('AB')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
        ...
        <div
          :class="['transform-card', traBC ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('BC', $event)"
          @click="showCache('BC')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
        ...
        <div
          :class="['transform-card', traCD ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('CD', $event)"
          @click="showCache('CD')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
        ...
        <div
          :class="['transform-card', traDG ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('DG', $event)"
          @click="showCache('DG')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
        ...
        <div
          :class="['transform-card', traF ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('F', $event)"
          @click="showCache('F')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
        ...
        <div
          :class="['transform-card', traGH ? 'transform-card-active' : '']"
          @dragover.prevent
          @drop="dropItem('GH', $event)"
          @click="showCache('GH')"
          @dragenter="dragEnter"
          @dragleave="dragLeave"
        >
    ...
    >
      ...
      >
        ...
        <el-table-column prop="tag" label="来源" width="100" fixed="right">
          <template>
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template slot-scope="scope">
            <el-link
              ...
              v-if="orderMainDy.orderId == scope.row.orderId"
              >当前运行订单</el-link
            >
            <el-link
              type="primary"
...
export default {
  ...
  data() {
    return {
      ...
      dialogVisible: false,
      tableTitle: [
        { prop: 'orderId', label: '任务编号', width: '200' },
        { prop: 'revertFlag', label: '翻转', width: '150' },
        { prop: 'batchId', label: '灭菌批号', width: '150' },
        { prop: 'orderNo', label: '订单编号', width: '150' },
        { prop: 'orderName', label: '订单名称', width: '150' },
        { prop: 'planNum', label: '计划数量', width: '150' },
        { prop: 'productName', label: '产品名称', width: '150' },
        { prop: 'loadMethod', label: '装载方式', width: '150' },
        { prop: 'pathName', label: '路径名称', width: '150' },
        { prop: 'artName', label: '工艺名称', width: '150' },
        { prop: 'acceleratorKValue', label: '加速器k值', width: '150' }
      ],
      tableData: [],
  ...
  watch: {
        ...
        if (newVal === '1') {
          ...
          if (this.nowNumberTurns == 1) {
            ...
            this.arrAB.push({
              ...
              orderNo: this.orderMainDy.orderNo,
              totalNumberTurns: this.orderMainDy.numberTurns,
              revertShowFlag: this.orderMainDy.revertFlag,
              boxImitateId: boxImitateId,
              numberTurns: 1,
              loadScanCode: this.loadScanCode,
              turnsInfoList: [
                {
                  numberTurns: 1,
                  passATime: moment().format('YYYY-MM-DD HH:mm:ss')
                }
              ]
            });
            // 判断当前箱子是不是当前批次消毒的第一个
            ...
            if (this.arrGH.length > 0) {
              for (let index = this.arrGH.length - 1; index >= 0; index--) {
                ...
                if (
                  this.arrGH[index].numberTurns >=
                  this.arrGH[index].totalNumberTurns
                ) {
            ...
            if (this.arrGH[0] != undefined) {
              ...
              if (this.arrGH[0].numberTurns < this.arrGH[0].totalNumberTurns) {
                ...
                this.arrAB[this.arrAB.length - 1].numberTurns =
                  this.arrAB[this.arrAB.length - 1].numberTurns + 1;
                const nowTurns = this.arrAB[this.arrAB.length - 1].numberTurns;
                this.arrAB[this.arrAB.length - 1].turnsInfoList.push({
                  numberTurns: nowTurns,
                  passATime: moment().format('YYYY-MM-DD HH:mm:ss')
                });
                // 显示箱子模拟id
                this.nowABoxImitateId =
                  this.arrAB[this.arrAB.length - 1].boxImitateId;
                // 生成日志
                this.createLog(
                  moment().format('YYYY-MM-DD HH:mm:ss') +
                    ' 货物' +
    ...
    pointE: {
      handler(newVal, oldVal) {
        ...
        // enteringPonitE
        if (!this.enteringPonitE && newVal === '1' && oldVal === '0') {
          //货物开始进入E点
        ...
        } else if (this.enteringPonitE && newVal === '0' && oldVal === '1') {
          // 货物走出E点
          // 进入E点写1，离开E点写0。
          ...
          if (this.arrDG.length > 0) {
            // 走出E点，读码
            this.labyrinthScanCode = this.labyrinthScanCodeTemp.replace(
              /\s/g,
              ''
            );
    ...
    err1: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 输送线上线急停被按下
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 输送线上线急停被按下!',
            'error'
          );
        }
      }
    ...
    err2: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 输送线下线急停被按下
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 输送线下线急停被按下!',
            'error'
          );
        }
      }
    ...
    err3: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 输送线电箱急停被按下
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 输送线电箱急停被按下!',
            'error'
          );
        }
      }
    ...
    err4: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 输送线变频过载
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 输送线变频过载!',
            'error'
          );
        }
      }
    ...
    err5: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 束下输送线变频过载
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 束下输送线变频过载!',
            'error'
          );
        }
      }
    ...
    err7: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 翻转机故障报警
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 翻转机故障报警!',
            'error'
          );
        }
      }
    ...
    err8: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 剔除机构故障报警
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 剔除机构故障报警!',
            'error'
          );
        }
      }
    ...
    err9: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 束下进货堵料
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 束下进货堵料!',
            'error'
          );
        }
      }
    ...
    err10: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 束下出货堵料
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 束下出货堵料!',
            'error'
          );
        }
      }
    ...
    err12: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 居中机构运转超限报警
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 居中机构运转超限报警!',
            'error'
          );
        }
      }
    ...
    err16: {
      handler(newVal, oldVal) {
        if (newVal == '1') {
          // 加速器紧急停机
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 加速器紧急停机!',
            'error'
          );
        }
      }
  ...
  methods: {
    ...
    qualified4Box(boxImitateIdVal, status) {
      ...
      for (let index = 0; index < this.arrBC.length; index++) {
        if (this.arrBC[index].boxImitateId == boxImitateIdVal) {
          if (
            this.arrBC[index].turnsInfoList[this.arrBC[index].numberTurns - 1]
              .qualified == undefined
          ) {
            this.arrBC[index].qualified = status ? '1' : '0';
            // 给当前圈也赋值合格
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].qualified = status ? '1' : '0';
            if (!status) {
              // 给后一个箱子赋值不合格
              if (index < this.arrBC.length - 1) {
                this.arrBC[index + 1].qualified = '0';
                // 给当前圈也赋值合格
                this.arrBC[index + 1].turnsInfoList[
                  this.arrBC[index + 1].numberTurns - 1
                ].qualified = '0';
                this.arrBC[index + 1].failReason =
                  moment().format('YYYY-MM-DD HH:mm:ss') +
                  ' 货物前后出现不合格箱子，疑似不合格！';
              }
              // 给前一个箱子赋值不合格
    ...
    judgeAccData(accData, boxImitateIdVal) {
      ...
      if (index != -1) {
        ...
        if (accData.beam != undefined && accData.beam != null) {
          if (
            Number(this.orderMainDy.slLowerLimit) > Number(accData.beam) ||
            Number(this.orderMainDy.slUpperLimit) < Number(accData.beam)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！束流设定最小值：' +
                this.orderMainDy.slLowerLimit +
                '，束流设定最大值：' +
                this.orderMainDy.slUpperLimit +
                '，束流读取值：' +
                accData.beam,
              'log'
            );
            this.arrBC[index].failReason =
              moment().format('YYYY-MM-DD HH:mm:ss') +
              ' 货物' +
              boxImitateIdVal +
              '工艺不合格！束流设定最小值：' +
        ...
        if (accData.power != undefined && accData.power != null) {
          if (
            Number(this.orderMainDy.glLowerLimit) > Number(accData.power) ||
            Number(this.orderMainDy.glUpperLimit) < Number(accData.power)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！功率设定最小值：' +
                this.orderMainDy.glLowerLimit +
                '，功率设定最大值：' +
                this.orderMainDy.glUpperLimit +
                '，功率读取值：' +
                accData.power,
              'log'
            );
        ...
        if (accData.scanW != undefined && accData.scanW != null) {
          if (
            Number(this.orderMainDy.skLowerLimit) > Number(accData.scanW) ||
            Number(this.orderMainDy.skUpperLimit) < Number(accData.scanW)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！扫宽设定最小值：' +
                this.orderMainDy.skLowerLimit +
                '，扫宽设定最大值：' +
                this.orderMainDy.skUpperLimit +
                '，扫宽读取值：' +
                accData.scanW,
              'log'
            );
        ...
        if (accData.scanF != undefined && accData.scanF != null) {
          if (
            Number(this.orderMainDy.smplLowerLimit) > Number(accData.scanF) ||
            Number(this.orderMainDy.smplUpperLimit) < Number(accData.scanF)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！扫描频率设定最小值：' +
                this.orderMainDy.smplLowerLimit +
                '，扫描频率设定最大值：' +
                this.orderMainDy.smplUpperLimit +
                '，扫描频率读取值：' +
                accData.scanF,
              'log'
            );
        ...
        if (accData.pfn != undefined && accData.pfn != null) {
          if (
            Number(this.orderMainDy.pfnLowerLimit) > Number(accData.pfn) ||
            Number(this.orderMainDy.pfnUpperLimit) < Number(accData.pfn)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！PFN电压设定最小值：' +
                this.orderMainDy.pfnLowerLimit +
                '，PFN电压设定最大值：' +
                this.orderMainDy.pfnUpperLimit +
                '，PFN电压读取值：' +
                accData.pfn,
              'log'
            );
        ...
        if (accData.energy != undefined && accData.energy != null) {
          if (
            Number(this.orderMainDy.nlLowerLimit) > Number(accData.energy) ||
            Number(this.orderMainDy.nlUpperLimit) < Number(accData.energy)
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                boxImitateIdVal +
                '工艺不合格！能量设定最小值：' +
                this.orderMainDy.nlLowerLimit +
                '，能量设定最大值：' +
                this.orderMainDy.nlUpperLimit +
                '，能量读取值：' +
                accData.energy,
              'log'
            );
        ...
        if (accData.speed != undefined && accData.speed != null) {
          if (
            Number(this.orderMainDy.sxSpeedLowerLimit) >
              Number(accData.speed) * 1000 ||
            Number(this.orderMainDy.sxSpeedUpperLimit) <
              Number(accData.speed) * 1000
          ) {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ...
                boxImitateIdVal +
                '工艺不合格！束下速度设定最小值：' +
                this.orderMainDy.sxSpeedLowerLimit +
                '，束下速度设定最大值：' +
                this.orderMainDy.sxSpeedUpperLimit +
                '，束下速度读取值：' +
                Number(accData.speed) * 1000,
              'log'
            );
      ...
      HttpUtil.get('/box/getAccDataByLocal')
        .then((res) => {
          ...
          if (index != -1) {
            ...
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].slRead = res.data.beam;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].glRead = res.data.power;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].skRead = res.data.scanW;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].smplRead = res.data.scanF;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].pfnRead = res.data.pfn;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].nlRead = res.data.energy;
            this.arrBC[index].turnsInfoList[
              this.arrBC[index].numberTurns - 1
            ].sxSpeedRead = Number(res.data.speed) * 1000;
          }
          if (
            res.data &&
            JSON.stringify(this.orderMainDy) != '{}' &&
            this.judgeAccData(res.data, boxImitateIdVal)
          ) {
            this.$message({
              type: 'success',
    ...
    replaceOrderData(orderMain) {
      if (orderMain.orderId === this.orderMainDy.orderId) {
        ...
        this.orderMainDy.revertFlag =
          this.orderMainDy.revertFlag == '1' ? '翻转' : '';
    ...
    async getCurrentTimeSort() {
      ...
      return (
        ...
        '' +
        day +
        String(this.beginCountNum + 1).padStart(4, '0')
      );
    },
    zeroFill(i) {
      if (i >= 0 && i <= 9) {
      ...
      switch (point) {
        case 'A':
          if (this.nowNumberTurns == 1) {
            ...
            if (
              this.arrAB[this.arrAB.length - 1].boxImitateId ==
              this.lastNewBoxPassABoxImitateId
            ) {
              if (
                this.arrAB[this.arrAB.length - 1].numberTurns ==
                this.arrAB[this.arrAB.length - 1].totalNumberTurns
              ) {
                // 开始上新货，当前箱子圈数变成1
            ...
            if (
              ...
              this.arrAB[this.arrAB.length - 1].loadScanCode == null ||
              this.arrAB[this.arrAB.length - 1].loadScanCode == undefined
            ) {
              this.arrAB[this.arrAB.length - 1].loadScanCode =
                this.loadScanCode;
            } else {
        ...
        case 'B':
          ...
          this.arrBC[this.arrBC.length - 1].turnsInfoList[
            this.arrBC[this.arrBC.length - 1].numberTurns - 1
          ].passBTime = moment().format('YYYY-MM-DD HH:mm:ss');
          // 删除AB队列第一个
          ...
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') +
              ' 货物' +
              this.arrBC[this.arrBC.length - 1].boxImitateId +
              '经过B点，扫码信息：' +
              this.arrBC[this.arrBC.length - 1].loadScanCode,
            'log'
          );
          break;
        case 'C':
          if (this.pointC === '1') {
            ...
            this.arrCD[this.arrCD.length - 1].turnsInfoList[
              this.arrCD[this.arrCD.length - 1].numberTurns - 1
            ].passCTime = moment().format('YYYY-MM-DD HH:mm:ss');
            // 删除BC队列第一个
            this.arrBC.splice(0, 1);
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                this.arrCD[this.arrCD.length - 1].boxImitateId +
                '经过C点，扫码信息：' +
                this.arrCD[this.arrCD.length - 1].loadScanCode,
              'log'
            );
            // 允许切换订单
            if (
              ...
              if (
                this.arrCD[this.arrCD.length - 1].numberTurns ==
                this.arrCD[this.arrCD.length - 1].totalNumberTurns
              ) {
                // 展示切换订单按钮
        ...
        case 'D':
          if (this.pointD === '1') {
            ...
            this.arrDG[this.arrDG.length - 1].turnsInfoList[
              this.arrDG[this.arrDG.length - 1].numberTurns - 1
            ].passDTime = moment().format('YYYY-MM-DD HH:mm:ss');
            // 删除BC队列第一个
            this.arrCD.splice(0, 1);
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                this.arrDG[this.arrDG.length - 1].boxImitateId +
                '经过D点，扫码信息：' +
                this.arrDG[this.arrDG.length - 1].loadScanCode,
              'log'
            );
          }
          break;
        case 'E':
          ...
          if (this.lastRouteEPoint === '') {
            // 说明物品第一次经过E点，直接取DG数组的第一个元素
          ...
          if (this.pointF === '1') {
            if (this.tempArrF.length > 0) {
              ...
              this.createLog(
                moment().format('YYYY-MM-DD HH:mm:ss') +
                  ' 货物' +
                  this.tempArrF[0].boxImitateId +
                  '经过F点，扫码信息：' +
                  this.tempArrF[0].loadScanCode +
                  '。被剔除！',
                'log'
              );
              // 删除tempArrF 第一个箱子
              ...
              for (let index = 0; index < this.arrDG.length; index++) {
                if (
                  this.arrF[this.arrF.length - 1].boxImitateId ==
                  this.arrDG[index].boxImitateId
                ) {
                  this.arrDG.splice(index, 1);
                  break;
                }
        ...
        case 'G':
          if (this.pointG === '1') {
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') +
                ' 货物' +
                this.arrDG[0].boxImitateId +
                '经过G点，扫码信息：' +
                this.arrDG[0].loadScanCode +
                '。当前 ' +
                this.arrDG[0].numberTurns +
                ' 圈，剩余 ' +
                (Number(this.arrDG[0].totalNumberTurns) -
                  Number(this.arrDG[0].numberTurns)) +
                ' 圈',
              'log'
            );
            // 判断是否符合下货条件
            if (this.arrDG[0].numberTurns >= this.arrDG[0].totalNumberTurns) {
              ...
              if (this.arrDG[0].orderId === this.orderMainDy.orderId) {
                ...
                this.nowOutNum++;
                this.arrDG[0].turnsInfoList[
                  this.arrDG[0].numberTurns - 1
                ].passGTime = moment().format('YYYY-MM-DD HH:mm:ss');
                // 发送下货指令
              ...
              await HttpUtil.post('/box/save', param)
                .then((res) => {
                  if (res.data == 1) {
                    this.$message.success(
                      '货物：' + this.arrDG[0].boxImitateId + '，已生成箱报告！'
                    );
                    this.createLog(
                      moment().format('YYYY-MM-DD HH:mm:ss') +
                        ' 货物' +
            ...
            if (this.arrDG[0].orderId === this.orderMainDy.orderId) {
              ...
              if (
                this.arrDG[0].boxImitateId === this.judgeBanLoadBoxImitateId &&
                this.arrDG[0].numberTurns < this.arrDG[0].totalNumberTurns
              ) {
                // 计算本箱子到达H点的时间（ms）
                // 计算时间 改为任务管理
                const times =
                  this.calculateMilliseconds(
                    (
                      Number(this.lengthOne) /
                      (Number(this.orderMainDy.sxSpeedSet) *
                        Number(this.speedOne))
                    ).toFixed(2),
                    (
                      Number(this.lengthTwo) /
                      (Number(this.orderMainDy.sxSpeedSet) *
                        Number(this.speedTwo))
                    ).toFixed(2)
                  ) + this.newDelayPointTime;
                this.startTimerWithDelay(8888, times);
                this.createLog(
                  moment().format('YYYY-MM-DD HH:mm:ss') +
                    ' 货物' +
                    this.arrDG[0].boxImitateId +
                    '，是本次上货的第一箱，经过G点，束下设定速度：' +
                    this.orderMainDy.sxSpeedSet +
                    '，X1长度：' +
                    this.lengthOne +
                    '，V1速度比：' +
              ...
              this.arrGH[this.arrGH.length - 1].turnsInfoList[
                this.arrGH[this.arrGH.length - 1].numberTurns - 1
              ].passGTime = moment().format('YYYY-MM-DD HH:mm:ss');
            }
            // 删除DG队列第一个
        ...
        case 'H':
          if (this.pointH === '1') {
            ...
            if (this.judgeLoadPoint === 'H') {
              // 判断是不是符合禁止上货条件
              if (
                this.arrGH[indexHBox].boxImitateId ==
                this.judgeBanLoadBoxImitateId
              ) {
                this.banLoadStatus = true; // 显示禁止上货图标
                // 给PLC发送禁止上货指令
            ...
            // 不是箱子最后一圈，更新进入H点时间
            if (
              this.arrGH[indexHBox].numberTurns !=
              this.arrGH[indexHBox].totalNumberTurns
            ) {
              this.arrGH[indexHBox].turnsInfoList[
                this.arrGH[indexHBox].numberTurns - 1
              ].passHTime = moment().format('YYYY-MM-DD HH:mm:ss');
            }
            ...
            if (this.arrGH[indexHBox].numberTurns >= this.nowNumberTurns) {
              ...
              if (
                ...
                this.createLog(
                  moment().format('YYYY-MM-DD HH:mm:ss') + ' 下货报警!',
                  'error'
                );
                // 发送报警信号
    ...
    judgeIfBoxOnH() {
      ...
      if (this.arrGH.length > 0) {
        for (let index = this.arrGH.length - 1; index >= 0; index--) {
          ...
          // this.arrGH[indexHBox].numberTurns >= this.arrGH[indexHBox].totalNumberTurns
          if (
            this.arrGH[index].numberTurns >= this.arrGH[index].totalNumberTurns
          ) {
            this.thoughHArr.push(this.arrGH[index]);
            this.arrGH.splice(index, 1);
          }
      ...
      if (this.nowNumberTurns == 1) {
        ...
        if (delayPointTime > 0) {
          if (!this.isDelayPointTime) {
            ...
            this.createLog(
              moment().format('YYYY-MM-DD HH:mm:ss') + ' H点开始延迟！',
              'log'
            );
    ...
    calculateTotalTime() {
      ...
      if (
        ...
        let timeForJ =
          pointjLength > 0 ? (pointjLength / jAreaSpeed) * 60 * 1000 : 0;
        let timeForK =
          pointkLength > 0 ? (pointkLength / kAreaSpeed) * 60 * 1000 : 0;
        let timeForL =
          pointlLength > 0 ? (pointlLength / lAreaSpeed) * 60 * 1000 : 0;
        // 计算总时间
        ...
        if (!this.isDelayPointTime) {
          this.createLog(
            moment().format('YYYY-MM-DD HH:mm:ss') + ' 计算的延迟时间：0',
            'log'
          );
        }
        return 0;
    ...
    judgeIfDGqualified(index) {
      ...
      // 更新进入E点时间
      this.arrDG[index].turnsInfoList[
        this.arrDG[index].numberTurns - 1
      ].passETime = moment().format('YYYY-MM-DD HH:mm:ss');
    ...
    async startPLC() {
      ...
      ipcRenderer.send(
        'writeValuesToPLC',
        'DBW22',
        Number(this.orderMainDy.boxWidth)
      );
      // DB101.DBW24 纸箱长度
      ipcRenderer.send(
        'writeValuesToPLC',
        'DBW24',
        Number(this.orderMainDy.boxLength)
      );
      this.$notify({
        title: '指令发送成功！',
        message: '全线启动指令已成功发送！',
      ...
      HttpUtil.get('/cssConfig/getConfig')
        .then((res) => {
          if (res.data) {
            ...
            this.pointjLength =
              res.data.pointjLength == null ? 0 : res.data.pointjLength;
            this.pointkLength =
              res.data.pointkLength == null ? 0 : res.data.pointkLength;
            this.pointlLength =
              res.data.pointlLength == null ? 0 : res.data.pointlLength;
            this.speedOne = res.data.speedOne == null ? 1 : res.data.speedOne;
            this.speedTwo = res.data.speedTwo == null ? 1 : res.data.speedTwo;
            this.newDelayPointTime =
              res.data.newDelayPointTime == null
                ? 0
                : res.data.newDelayPointTime;
            this.lengthOne =
              res.data.lengthOne == null ? 0 : res.data.lengthOne;
            this.lengthTwo =
              res.data.lengthTwo == null ? 0 : res.data.lengthTwo;
          } else {
                ...
                .then((res) => {
                  if (res.data) {
                    ...
                    this.createLog(
                      moment().format('YYYY-MM-DD HH:mm:ss') +
                        ' 用户：' +
                        remote.getGlobal('sharedObject').userInfo.userName +
                        '进行了全线清空操作！',
                      'log'
                    );
                  } else {
    ...
    delayHpoint() {
      ...
      this.createLog(
        moment().format('YYYY-MM-DD HH:mm:ss') + ' H点开始延迟结束！',
        'log'
      );
    },
    delayGpoint() {
      this.createLog(
        moment().format('YYYY-MM-DD HH:mm:ss') + ' 首箱到达H点！',
        'log'
      );
      this.judgeIfBoxOnH();
    },
    ...
    pauseAllTimers() {
      if (this.timersRunStatus) {
        for (const boxImitateId in this.timers) {
          ...
          this.timers[boxImitateId].remainingTime =
            this.timers[boxImitateId].endTime - Date.now();
