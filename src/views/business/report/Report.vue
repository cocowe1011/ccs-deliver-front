          ...
          <div class="card-content">
            <div>
              ...
              ><el-button
                ...
                size="small"
                @click="openReport(boxReportPath)"
                :loading="openBoxLoading"
                >箱设计</el-button
              >
            </div>
            <div>
              ...
              ><el-button
                style="margin-left: 10px"
                size="small"
                @click="openReport(orderReportPath)"
        ...
        <div class="listDiv">
          ...
          <div class="tableDiv">
            ...
            >
              ...
              <el-table-column prop="batchId" label="灭菌批号">
              </el-table-column>
              <el-table-column prop="orderName" label="订单名称">
              </el-table-column>
              <el-table-column prop="boxImitateId" label="箱编号">
              </el-table-column>
              <el-table-column prop="productName" label="产品名称">
              </el-table-column>
              <el-table-column prop="artName" label="工艺名称">
              </el-table-column>
              <el-table-column prop="loadMethod" label="装载方式">
              </el-table-column>
              <el-table-column prop="pathName" label="路径名称">
              </el-table-column>
              <el-table-column fixed="right" label="操作" width="180">
                <template slot-scope="scope">
                  <el-link
                    ...
                    @click="getOrderReportData(scope.row)"
                    >批报告</el-link
                  >
                  <el-link
                    type="primary"
                    icon="el-icon-receiving"
                    @click="getBoxReportData(scope.row)"
...
export default {
  ...
  methods: {
    ...
    async getReportSearch() {
      ...
      await HttpUtil.post('/order/getReportList', param)
        .then((res) => {
    ...
    async getOrderReportData(row) {
      ...
      await HttpUtil.post('/order/getOrderMainReport', param)
        .then((res) => {
    ...
    async getBoxReportData(row) {
      ...
      await HttpUtil.post('/box/getBoxReport', param)
        .then((res) => {
          this.printObj.recordset = res.data;
