        ...
        <div class="card-content">
          ...
          >
            ...
            <el-form-item label="J长度(mm)：">
              <el-input
                v-model="cssConfig.pointjLength"
                style="width: 250px"
                type="number"
              ></el-input>
            </el-form-item>
            <el-form-item label="K长度(mm)：">
              <el-input
                v-model="cssConfig.pointkLength"
                style="width: 250px"
                type="number"
              ></el-input>
            </el-form-item>
            <el-form-item label="L长度(mm)：">
              <el-input
                v-model="cssConfig.pointlLength"
                style="width: 250px"
                type="number"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="G点延迟时间(ms)：">
              <el-input
                v-model="cssConfig.newDelayPointTime"
                style="width: 250px"
                type="number"
              ></el-input>
            </el-form-item>
